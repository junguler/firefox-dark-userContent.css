...
i have set `text` to light grey (#cccccc) and `background` (#222222) to dark grey, set `override the colors specified by the page with your selections above` to `always`
